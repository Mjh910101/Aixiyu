...
//    private PendingIntent updatePendingIntent = null;
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (Environment.MEDIA_MOUNTED.equals(Environment
            ...
            updateDir = new File(DownloadImageLoader.getRootPath());
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case DOWNLOAD_COMPLETE:
                    ...
                    Uri uri;
                    if (GetPathFromUriHandler.isN()) {
                        uri = FileProvider.getUriForFile(getApplicationContext(), BuildConfig.APPLICATION_ID + ".fileProvider", updateFile);
...
//                    installIntent.setDataAndType(GetPathFromUriHandler.getUri(context, uri), "application/vnd.android.package-archive");
