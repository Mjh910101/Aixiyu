...
public class DownloadImageLoader {
    ...
    private final static int INDEX_IMAGE = R.drawable.loding_icon;
    private final static int FAIL_IMAGE = R.drawable.loding_icon;
    private final static int EMPTY_IMAGE = R.drawable.loding_icon;

    private final static String RootName = "Ispanish";
