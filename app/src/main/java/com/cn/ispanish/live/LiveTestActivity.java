 ...
 * *   ┃┫┫   ┃┫┫
 * *   ┗┻┛   ┗┻┛
 * Created by Hua on 17/9/12.
 */
public class LiveTestActivity extends FragmentActivity {
...
//        cid = getIntent().getStringExtra("cid");
    ...
    private void addFragment() {
        ...
        polyvChatFragment.initChatConfig(uid, cid, User.getName(context), User.getPortrait(context),null);
