...
public class PolyvChatAdapter extends BaseAdapter implements OnClickListener {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        switch (message.getChatType()) {
            ...
            case PolyvChatMessage.CHATTYPE_SEND:
                tv_name.setText(User.getName(context));
                ImageLoader.getInstance().displayImage(User.getPortrait(context), iv_avatar, options);
    ...
    public void addHistory(List<PolyvChatMessage> dataList) {
        for (PolyvChatMessage message : dataList) {
            messages.add(message);
        }
        notifyDataSetChanged();
    }
