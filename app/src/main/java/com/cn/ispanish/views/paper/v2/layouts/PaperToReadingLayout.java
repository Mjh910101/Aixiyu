...
public class PaperToReadingLayout extends PaperContentView {
    ...
    public PaperToReadingLayout(Context context, ReadingQuestion question, int position, OnQuestionListener onQuestion, QuestionCommentAdapter.CallbackForComment callbackForComment) {
