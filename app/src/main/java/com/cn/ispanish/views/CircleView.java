...
//    private int mWaveColor = Color.WHITE;
    ...
    private void init(Context context) {
        ...
        mRingPaint.setColor(ColorHandle.getColorForID(context, R.color.blue_af));
//        mRingPaint.setAlpha(50);
        ...
        mCirclePaint.setColor(ColorHandle.getColorForID(context, R.color.bleu_36));
        ...
        leftPaint = new Paint();
        leftPaint.setColor(ColorHandle.getColorForID(context, R.color.gray_text_66));
        leftPaint.setStyle(Paint.Style.FILL);
        leftPaint.setAntiAlias(true);
        leftPaint.setTextSize(46);

        mWavePaint = new Paint();
        mWavePaint.setStrokeWidth(1.0F);
        mWavePaint.setColor(ColorHandle.getColorForID(context, R.color.bleu_36));
//        mWavePaint.setAlpha(mAlpha);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        setBackgroundColor(mContext.getResources().getColor(R.color.white_00));
        // 计算当前油量线和水平中线的距离
