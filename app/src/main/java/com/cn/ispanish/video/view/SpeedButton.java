package com.cn.ispanish.video.view;
		...
		setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				case speed_05:
					...
					MessageHandler.showToast(getContext(), "当前为1倍速");
					break;
				...
				case speed_1:
					...
					MessageHandler.showToast(getContext(), "当前为1.2倍速");
					break;
				...
				case speed_12:
					...
					MessageHandler.showToast(getContext(), "当前为1.5倍速");
					break;
				...
				case speed_15:
					...
					MessageHandler.showToast(getContext(), "当前为2倍速");
					break;
				...
				case speed_2:
					...
					MessageHandler.showToast(getContext(), "当前为0.5倍速");
					break;
				}
			}
		});
