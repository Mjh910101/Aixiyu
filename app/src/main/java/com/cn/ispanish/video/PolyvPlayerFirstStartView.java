...
import com.cn.ispanish.video.listeners.AnimateFirstDisplayListener;
...
public class PolyvPlayerFirstStartView extends RelativeLayout {
    ...
    private void initViews() {
    	...
    	if (mOptions == null) {
    		mOptions = new DisplayImageOptions.Builder().showImageOnLoading(R.drawable.loding_icon) // 设置图片在下载期间显示的图片
    				.showImageForEmptyUri(R.drawable.loding_icon)// 设置图片Uri为空或是错误的时候显示的图片
    				.showImageOnFail(R.drawable.loding_icon) // 设置图片加载/解码过程中错误时候显示的图片
