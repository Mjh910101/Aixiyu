...
public class PolyvDBOpenHepler extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL(
                "create table if not exists downloadlist (vid varchar(64),courseid varchar(64),speed varchar(15),title varchar(100),image varchar(256),duration varchar(20),filesize int,bitrate int,percent int default 0,total int default 0,primary key (vid, bitrate,speed))");
    }
