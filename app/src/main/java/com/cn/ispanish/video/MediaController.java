...
import com.cn.ispanish.video.dialog.SendDanmakuDialog;
import com.cn.ispanish.video.view.SpeedButton;
...
public class MediaController extends IjkBaseMediaController {
    ...
    protected void initControllerView(View v) {
        ...
        backView = (ImageView) mRoot.findViewById(R.id.mediaController_back);
        backView.setOnClickListener(backListener);

        collection = (ImageView) mRoot.findViewById(R.id.mediaController_collection);
    ...
    public void setOnCollectionListener(OnClickListener listener) {
    ...
    public void setCollection( boolean b) {
        ...
        if (b) {
            ...
            collection.setImageResource(R.drawable.video_collection_off_icon);
        }
    }
    ...
    private class GetDFNumWork extends AsyncTask<String, String, Integer> {
        ...
        protected Integer doInBackground(String... params) {
            ...
            if (currBitRate < 0) {
                currBitRate = 0;
//                currBitRate = VideoInfo.getBitRateEnum(mContext).getNum();
            }
