...
public class LiveCommentAdapter extends BaseAdapter {
    ...
    Context context;
    List<LiveComment> itemList;

    CallbackForComment callback;

    public LiveCommentAdapter(Context context, List<LiveComment> itemList) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        LiveComment comment = itemList.get(i);
    ...
    private void setData(Holder holder, LiveComment comment) {
    ...
    private void setOnGood(ImageView view, final LiveComment comment) {
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (comment.isGood()) {
                    ...
                    uploadGoodData(UrlHandle.getLiveCommenGood(context), comment);
                }
            }
        });
    }

    private void uploadGoodData(String url, final LiveComment comment) {
        RequestParams params = HttpUtilsBox.getRequestParams(context);
        params.addBodyParameter("key", User.getAppKey(context));
        params.addBodyParameter("comid", comment.getId());
    ...
    private void setOnCommentIcon(ImageView view, final LiveComment comment) {
        view.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (callback != null) {
    ...
    public interface CallbackForComment {
        void callback(LiveComment comment);
    }

    private void setConntntList(InsideListView listView, List<LiveComment> list) {
    ...
    class Adapter extends BaseAdapter {
        ...
        Adapter(List<LiveComment> itemList) {
            this.itemList = itemList;
        }
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            LiveComment obj = itemList.get(i);
