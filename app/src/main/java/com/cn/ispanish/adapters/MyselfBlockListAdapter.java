 ...
 */
public class MyselfBlockListAdapter extends BaseAdapter {

    private Context context;
    private List<IndexBlock> itemDataList;

    public MyselfBlockListAdapter(Context context) {
        this.context = context;
        this.itemDataList = new ArrayList<>();
    }

    public MyselfBlockListAdapter(Context context, List<IndexBlock> itemDataList) {
        this.context = context;
