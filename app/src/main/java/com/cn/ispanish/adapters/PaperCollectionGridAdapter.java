...
import com.cn.ispanish.activitys.CollectionPaperQuestionActivity;
 ...
 */
public class PaperCollectionGridAdapter extends BaseAdapter {

    Context context;
    List<Paper> itemList;

    public PaperCollectionGridAdapter(Context context, List<Paper> itemList) {
    ...
    private void setOnClick(View view, final Paper paper) {
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Bundle b = new Bundle();
                b.putString(CollectionPaperQuestionActivity.KID_KEY, paper.getId());
                b.putString(CollectionPaperQuestionActivity.PAPER_TITLE_KEY, paper.getName());
                b.putBoolean(CollectionPaperQuestionActivity.COLL_KEY, paper.isColl());

                PassagewayHandler.jumpActivity(context, CollectionPaperQuestionActivity.class, b);
            }
        });
    }
