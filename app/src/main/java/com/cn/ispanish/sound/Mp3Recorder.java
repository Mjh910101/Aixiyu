...
public class Mp3Recorder {
     ...
     * 16 bits pcm
     */
    public Mp3Recorder(String voiceName) {
    ...
    private void initAudioRecorder() throws IOException {
        ...
        String externalPath = Environment.getExternalStorageDirectory()
                .getAbsolutePath();
        File directory = new File(getSoundPath());
        if (!directory.exists()) {
            directory.mkdirs();
            Log.d(TAG, "Created directory");
        }
        mp3File = new File(directory, voiceName);
    ...
    public static String getSoundPath() {
        return Environment.getExternalStorageDirectory().getAbsolutePath() + "/Ispanish";
    }
}