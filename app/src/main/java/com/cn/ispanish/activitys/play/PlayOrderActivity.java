...
//                    MessageHandler.showToast(context, "" + d);
    ...
    private void downloadOrderIdToZhifubaoAndBalance(String paychange) {
        ...
        HttpUtilsBox.getHttpUtil().send(HttpRequest.HttpMethod.POST, UrlHandle.getAliPayBalance(context), params,
    ...
    private void downloadOrderIdToZhifubao() {
        ...
        HttpUtilsBox.getHttpUtil().send(HttpRequest.HttpMethod.POST, UrlHandle.getAndpayali(context), params,
                new RequestCallBack<String>() {
    ...
    private void downloadOrderIdToWeixinAndBalance(String paychange) {
        ...
        HttpUtilsBox.getHttpUtil().send(HttpRequest.HttpMethod.POST, UrlHandle.getWxPayBalance(context), params,
                new RequestCallBack<String>() {
    ...
    private void downloadOrderIdToWeixin() {
        ...
        HttpUtilsBox.getHttpUtil().send(HttpRequest.HttpMethod.POST, UrlHandle.getWxpay(context), params,
                new RequestCallBack<String>() {
...
//        d = ((int) (d * 100)) / 100;
    ...
    private void buy4Balance() {
        ...
        HttpUtilsBox.getHttpUtil().send(HttpRequest.HttpMethod.POST, UrlHandle.getBuyClassBalance(context), params,
                new RequestCallBack<String>() {
