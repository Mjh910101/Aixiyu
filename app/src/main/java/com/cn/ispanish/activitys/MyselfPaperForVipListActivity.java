 ...
 */
public class MyselfPaperForVipListActivity extends BaseActivity {
    ...
    private void downloadData() {
        ...
        HttpUtilsBox.getHttpUtil().send(HttpRequest.HttpMethod.POST, UrlHandle.getBackBuyInformation(context), params,
