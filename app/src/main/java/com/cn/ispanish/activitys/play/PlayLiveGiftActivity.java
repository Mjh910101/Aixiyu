 ...
 */
public class PlayLiveGiftActivity extends BaseActivity {
    ...
    public final static int Result_Code = 22252;
...
//                    MessageHandler.showToast(context, "" + d);
    ...
    private void playOrderInZhufubao(String indent, String price) {
         ...
         * 完整的符合支付宝参数规范的订单信息
         */
        final String payInfo = ZhiFuBao.getCourseOrderInfo(TextHandler.getText(orderTitleText), price, indent, OrderInfoUtil2_0.Course_Balance_Notify_Url);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                // 构造PayTask 对象
                PayTask alipay = new PayTask(PlayLiveGiftActivity.this);
                // 调用支付接口，获取支付结果
    ...
    private void downloadOrderIdToZhifubao() {
        ...
        params.addBodyParameter("gid", cID);
        params.addBodyParameter("key", User.getAppKey(context));

        HttpUtilsBox.getHttpUtil().send(HttpRequest.HttpMethod.POST, UrlHandle.getAlipayGift(context), params,
    ...
    private void playOrderInZhufubao(String indent) {
         ...
         * 完整的符合支付宝参数规范的订单信息
         */
        final String payInfo = ZhiFuBao.getCourseOrderInfo(TextHandler.getText(orderTitleText), money, indent, OrderInfoUtil2_0.Gift_Notify_Url);
    ...
    private void downloadOrderIdToWeixin() {
        ...
        HttpUtilsBox.getHttpUtil().send(HttpRequest.HttpMethod.POST, UrlHandle.getWxpayGift(context), params,
                new RequestCallBack<String>() {
...
//        d = ((int) (d * 100)) / 100;
    ...
    private void buy4Balance() {
        ...
        HttpUtilsBox.getHttpUtil().send(HttpRequest.HttpMethod.POST, UrlHandle.getGiftBalance(context), params,
                new RequestCallBack<String>() {
